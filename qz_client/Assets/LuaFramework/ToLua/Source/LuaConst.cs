...
public static class LuaConst
{
	...
	public static string gameDir = Application.dataPath + "/LuaFramework/game/src";
    ...
    public static string toluaResDir = string.Format("{0}/{1}/ToLua/Lua", Application.persistentDataPath, osDir);
    public static string GameResDir = string.Format("{0}/{1}/game", Application.persistentDataPath, osDir);
